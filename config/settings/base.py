"""
Django settings2 for config project.
...
For the full list of settings2 and their values, see
...
SECRET_KEY = 'django-insecure-15)tt1z*235l!xt*62sx*vb+_5u3_ar4aurekn6c1o%69z9klz'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["*"]
# ALLOWED_HOSTS = ['192.168.0.73','127.0.0.1']
